...
const { uploadImage, uploadSignature, handleUploadError, uploadDataSheetOrCatalog } = require('../controllers/uploadController');
...
router.post('/datasheet-or-catalog', upload.single('file'), handleUploadError, uploadDataSheetOrCatalog);
